...
from framework.preprocessing.data_loader import load_ASD_data
...
if retrain_model:
    ...
    kf.save_model(r'C:\Users\smlin\Documents\GitHub\NSIBF\UsmanCode\NSIBF_EKF\results\ASD')
    print('optHPCfg',optHPCfg)
    print('bestScore',bestScore)
else:
    kf = kf.load_model('C:/Users/smlin/Documents/Github/NSIBF/UsmanCode/NSIBF_EKF/results/ASD')
